  ...
  const fetchDashboardStats = async () => {
    ...
    try {
      ...
      if (tasksResponse.ok && documentsResponse.ok) {
        ...
        console.warn('API calls failed, using mock data. Status:', {
          tasks: tasksResponse.status,
          documents: documentsResponse.status
        });
